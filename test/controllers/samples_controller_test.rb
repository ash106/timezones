...
class SamplesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sample" do
    assert_difference("Sample.count") do
      post samples_url, params: { sample: { collection_date: @sample.collection_date, name: @sample.name } }
    end
  ...
  test "should update sample" do
    patch sample_url(@sample), params: { sample: { collection_date: @sample.collection_date, name: @sample.name } }
